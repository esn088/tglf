...
//var l=document.getElementById("imprimir").innerHTML = JSON.stringify(data,null,2);
senator();
function senator(){
...
for(var i=0;i<members.length;i++){
  var primertr =document.createElement("tr");
               ...
               colname.textContent =data.results[0].members[i].first_name;
